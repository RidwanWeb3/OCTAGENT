...
function AuthPage() {
  ...
  return (
    <div className="page-shell page-shell--subtle dark min-h-screen">
      ...
      <div className="page-content flex min-h-screen items-center justify-center px-6 relative overflow-hidden">
        ...
        <div className="relative glass rounded-3xl p-10 max-w-md w-full">
          <div className="flex flex-col items-center text-center">
            <img src={mascot} alt="OCTAGEN" className="w-16 h-16 mb-4 drop-shadow-[0_0_20px_oklch(0.86_0.28_138_/_0.6)]" />
          ...
          <button
            onClick={google}
            disabled={busy}
            className="mt-8 w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl bg-neon text-primary-foreground text-sm font-mono tracking-[0.24em] uppercase hover:animate-pulse-neon transition disabled:opacity-50"
          >
...
function EmailAuth() {
  ...
  return (
    <form onSubmit={submit} className="mt-4 space-y-3">
      ...
      <button disabled={busy} className="w-full py-2.5 rounded-lg glass hover:border-neon/50 text-sm font-mono tracking-[0.22em] uppercase transition disabled:opacity-50">
